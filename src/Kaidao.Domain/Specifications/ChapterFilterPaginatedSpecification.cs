                ...
                if (item.Contains("where:"))
                {
                    ...
                    if (whereEqual.Length == 2)
                    {
                        switch (whereEqual[0])
                        {
                            case "where:order":
                                int order;
                                if (int.TryParse(whereEqual[1], out order))
                                {
                            ...
                            case "where:keyword":
                                if (!string.IsNullOrEmpty(whereEqual[1]))
                                {
                                    AddWhere(x =>
                                        x.Name.Contains(whereEqual[1])
                                     || x.Url.Contains(whereEqual[1])
                                    );
                                }
                                break;
                    ...
                    if (whereBigger.Length == 2)
                    {
                        switch (whereBigger[0])
                        {
                            case "where:order":
                                int order;
                                if (int.TryParse(whereBigger[1], out order))
                                {
                                    AddWhere(x => x.Order >= order);
                                }
                                break;
                    ...
                    if (whereSmaller.Length == 2)
                    {
                        switch (whereSmaller[0])
                        {
                            case "where:order":
                                int order;
                                if (int.TryParse(whereSmaller[1], out order))
                                {
                                    AddWhere(x => x.Order <= order);
                                }
                                break;
